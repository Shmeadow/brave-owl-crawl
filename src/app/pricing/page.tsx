    ...
    <div className="bg-background min-h-screen text-foreground">
      <header className="container mx-auto py-4 flex justify-between items-center border-b">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link href="#" className="text-sm font-medium text-muted-foreground hover:text-foreground">Blog</Link>
          <Link href="#" className="text-sm font-medium text-muted-foreground hover:text-foreground">Gallery</Link>
      ...
      <footer className="container mx-auto py-6 text-center text-muted-foreground text-sm border-t">
