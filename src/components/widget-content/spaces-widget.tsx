      ...
      <div className="space-y-8 max-w-5xl mx-auto py-4">
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {/* Empty box 1 */}
            <Card className="relative h-48 overflow-hidden group bg-muted/50 border border-border flex items-center justify-center text-muted-foreground">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {Array.from({ length: 14 }).map((_, index) => (
              <Card key={index} className="relative h-48 overflow-hidden group bg-muted/50 border border-border flex items-center justify-center text-muted-foreground">
