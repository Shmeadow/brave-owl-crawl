...
export function PublicRoomsSection({ publicRooms }: PublicRoomsSectionProps) {
  ...
  // The publicRooms prop passed to this component should now ONLY contain rooms
  // that are public and not created/joined by the current user.
  ...
  return (
    <Card className="w-full bg-background/50 backdrop-blur-xl border-white/20 p-4">
      <CardHeader className="pb-4">
        <CardTitle className="text-xl">Explore Rooms</CardTitle>
      </CardHeader>
