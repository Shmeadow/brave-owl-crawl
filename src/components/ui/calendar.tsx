...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ((props: React.ComponentPropsWithoutRef<'svg'>) => <ChevronLeft className="h-4 w-4" {...props} />) as any,
        IconRight: ((props: React.ComponentPropsWithoutRef<'svg'>) => <ChevronRight className="h-4 w-4" {...props} />) as any,
      }}
      {...props}
    />
  );
