        ...
        <TooltipTrigger asChild>
          <Button
            ...
            className={cn(
              ...
              isExpanded ? "w-full flex-col justify-center px-1 h-12" : "w-12 flex-col justify-center" // Conditional width, padding, and height
            )}
            onClick={onClick}
          >
            <Icon className={cn("h-6 w-6", isExpanded && "mb-1")} />
