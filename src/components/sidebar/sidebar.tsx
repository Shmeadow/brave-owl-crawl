...
import { MOBILE_HORIZONTAL_SIDEBAR_HEIGHT, HEADER_HEIGHT_MOBILE } from "@/lib/constants"; // Import new constant
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isMobile ?
          `top-[${HEADER_HEIGHT_MOBILE + 4}px] left-0 right-0 flex-row justify-around p-0.5 gap-0.5 rounded-none overflow-x-auto` : // Mobile: horizontal, below header with 4px gap
