...
import { MOBILE_HORIZONTAL_SIDEBAR_HEIGHT, MOBILE_HEADER_EFFECTIVE_HEIGHT, MOBILE_HEADER_SIDEBAR_GAP, MOBILE_SIDEBAR_TOP_OFFSET } from "@/lib/constants"; // Import new constant
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isMobile ?
          `top-[${MOBILE_SIDEBAR_TOP_OFFSET}px] left-0 right-0 flex-row justify-around p-0.5 gap-0.5 rounded-none overflow-x-auto` : // Mobile: horizontal, using new fixed top offset
