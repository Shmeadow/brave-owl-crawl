...
type ActivePanel = 'spaces' | 'sounds' | 'calendar' | 'timer' | 'tasks' | 'notes' | 'media' | 'fortune' | 'flash-cards' | 'goal-focus';
...
export function SidebarProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (savedPanel && ['spaces', 'sounds', 'calendar', 'timer', 'tasks', 'notes', 'media', 'fortune', 'flash-cards', 'goal-focus'].includes(savedPanel)) {
