...
import { MOBILE_HORIZONTAL_SIDEBAR_HEIGHT, MOBILE_HEADER_EFFECTIVE_HEIGHT, MOBILE_HEADER_SIDEBAR_GAP, MOBILE_SIDEBAR_CONTENT_GAP, MOBILE_SIDEBAR_TOP_OFFSET } from '@/lib/constants'; // Import new constant
  ...
  if (isMobile) {
    return (
      <div className={cn(
        ...
        `top-[${MOBILE_SIDEBAR_TOP_OFFSET + MOBILE_HORIZONTAL_SIDEBAR_HEIGHT + MOBILE_SIDEBAR_CONTENT_GAP}px]`, // Adjusted top position with new gaps
